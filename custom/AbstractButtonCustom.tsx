...
import { Styles } from '../react/features/base/toolbox/components/AbstractToolboxItem';
import { combineStyles } from '../react/features/base/styles/functions.any';
import { NOTIFY_CLICK_MODE } from '../react/features/toolbox/constants';
 ...
 */
export default class AbstractButtonCustom<P extends IProps, S = any> extends Component<P, S> {
    static defaultProps = {
    ...
    /**
     * Initializes a new {@code AbstractButtonCustom} instance.
     *
     * @param {IProps} props - The React {@code Component} props to initialize
     * the new {@code AbstractButtonCustom} instance with.
     */
    constructor(props: P) {
        super(props);
